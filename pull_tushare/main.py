...
def manual_start():
    ...
    ###### 二、明细数据更新：要建线程池
    # 4.更新频率：月、周、日
    logger.info(' 4.详细信息更新频率：月、周、日')
    detail_list = [IndexMemberTushare]  # 月更新
    detail_list += [DailyTushare, DailyBasicTushare, AdjFactorTushare,
                    FundDailyTushare, FundNavTushare, FundAdjTushare,
                    IndexDailyTushare]  # 日更新
    ...
    with ThreadPoolExecutor(max_workers=cpu_count * 4) as pool:
