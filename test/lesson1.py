...
for stock in daily_price['sec_code'].unique():
    ...
    cerebro.adddata(datafeed, name=stock) # 通过name实现数据集与股票的一一对应
    print(f"{stock} feed Done!")

print("All stock feed Done!")
...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        # 读取调仓日期，即每月的对后一个交易日，回测时，会在这一天下单，然后在下一个交易日，以开盘价买入
